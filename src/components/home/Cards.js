    ...
    return (
        <div className="container-fluid pt-5 pb-lg-5">
            <div className="container">
                ...
                <div className="container hm-card">
                    <div className="row">
                        ...
                        <div className="col-12 pt-2 pt-lg-0 col-lg-7 pl-4">
                            <h1 className="pt-2 pb-3 pb-lg-2">Vauven</h1>
                ...
                <div className="container hm-card">
                    <div className="row">
                        <div className="col-12 col-lg-5 hs-header d-flex align-items-md-center">
                        ...
                        <div className="col-12 pt-2 pt-lg-0 col-lg-7 pl-4">
                            <h1 className="pt-2 pb-3 pb-lg-2">Haven Station</h1>
