                ...
                <div className="container hm-card">
                    <div className="row">
                        <div className="col-12 col-lg-5 d-flex align-items-end bpm-header">
                            <Link to={"/case-studies/bpmusic"}><img className="img-fluid" alt="BPMusic Logo and Prototype on Phones" src={bpm} /></Link>
                        </div>
                        <div className="col-12 col-lg-7 pl-4">
                            ...
                            <p className="d-flex justify-content-end pb-1 pr-2"><Link to={"/case-studies/bpmusic"}>View case study</Link></p>
                        </div>
                    </div>
                </div>
            </div>
