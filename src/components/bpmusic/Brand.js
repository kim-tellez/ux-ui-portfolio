    ...
    return (
        <div className="container-fluid pt-5 pb-lg-5">
            <div className="container">
                ...
                <p className="pb-md-3">During this new phase of BPMusic, we need to tap into the power of community. Music and exercise both have the potential to energize, connect, and heal. At BPMusic, we catalyze that potential to offer a music streaming experience like no other at the intersection of music, fitness, and charity.</p>
                <p className="pb-3 d-block d-md-none">Click image to enlarge.</p>
