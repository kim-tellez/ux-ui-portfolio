    ...
    return (
        <div className="container-fluid pt-5 pb-lg-5">
            <div className="container">
                ...
                <h3 className="pb-md-3">High-Fidelity Screens</h3>
                <p className="pt-3 pb-3 d-block d-md-none">Click image to enlarge.</p>
                <a target="_blank" rel="noreferrer" href={screens}><img className="img-fluid d-flex m-auto pb-5" alt="Collection of high-fidelity screens" src={screens} /></a>
            </div>
        </div>   
    );
}